...
- **Настройки Directus в git** - цвета, темы, интерфейс сохраняются в репозитории
...
- ✅ **Настройки Directus сохраняются** - все изменения интерфейса Directus в git
- ✅ **Единая база данных** - нет дублирования данных
- ✅ **Автоматические бэкапы** - ежедневное резервное копирование БД
